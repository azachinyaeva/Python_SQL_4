...
with psycopg2.connect(database="hw_clients", user="postgres", password="postgres") as conn:
    ...
    # add_phone(conn, 7, "79500000000")
    # add_phone(conn, 13, "79100011000")
    # delete_client(conn, 5)
    # delete_phone(conn, 11, "79000000000")
    change_client(conn, 6, last_name="Done")
    find_client(conn, last_name="Done")
